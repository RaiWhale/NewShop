...
namespace TechnologyShop.Helpers
{
    public class FilesHelper
    {
        ...
        public FilesHelper(String DeleteURL, String DeleteType, String StorageRoot, String UrlBase, String tempPath, String serverMapPath, String productId)
        {
            this.DeleteURL = DeleteURL;
            this.DeleteType = DeleteType;
            this.StorageRoot = StorageRoot+productId+"/";
            this.UrlBase = UrlBase + productId + "/";
            this.tempPath = tempPath + productId + "/";
            this.serverMapPath = serverMapPath + productId + "/";
        }
        ...
        public String DeleteFile(String file)
        {
            ...
            String thumbPath = "/" + file + ".jpg";
            String partThumb1 = Path.Combine(StorageRoot, "thumbs");
            String partThumb2 = Path.Combine(partThumb1, Path.GetFileNameWithoutExtension(file) + ".jpg");
        ...
        private void UploadPartialFile(string fileName, HttpContextBase requestContext, List<ViewDataUploadFilesResult> statuses)
        {
            ...
            var ThumbfullPath = Path.Combine(fullName, Path.GetFileName(file.FileName + ".jpg"));
        ...
        public String CheckThumb(String type,String FileName)
        {
            ...
            if (splited.Length == 2)
            {
                ...
                {
                    String thumbnailUrl = UrlBase + "thumbs/" + Path.GetFileNameWithoutExtension(FileName) + ".jpg";
                    return thumbnailUrl;
                }
                else
                {
            ...
            {
                return UrlBase + "/thumbs/" + Path.GetFileNameWithoutExtension(FileName) + ".jpg";
            }
